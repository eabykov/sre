...
3. Обратите внимание на временные показатели, такие как MTTD (среднее время до обнаружения), MTTA (среднее время до подтверждения), MTTM (среднее время до митигации) и MTTR (среднее время восстановления).
...
### 5. Проводить интеграционные тесты, наблюдая за тем, как наши изменения встраиваются в общую архитектуру и взаимодействуют с другими компонентами
...
2. Предусмотреть безопасность внесения изменений, чтобы система не вошла в Состояние Опасности. Вливать MR только после аппрува лида и прохождения CI-пайплайна.
